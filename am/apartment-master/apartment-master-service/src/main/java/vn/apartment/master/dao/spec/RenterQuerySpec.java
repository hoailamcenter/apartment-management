...
public class RenterQuerySpec {
    private static final String RENTER_FIRST_NAME = "firstName";
    ...
    static {
        SORTED_FIELDS.put("email", RENTER_EMAIL);
    }
    ...
    public static Specification<Renter> newSpecification(ApiQuery apiQuery) {
        return (root, query, cb) -> {
            ...
            queries.add(cb.like(root.get(RENTER_FIRST_NAME), keyword));
